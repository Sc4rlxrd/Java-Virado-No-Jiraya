...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        System.out.println(STR."1: \{absolute1.relativize(absolute3)}");
        System.out.println(STR."2: \{absolute3.relativize(absolute1)}");
        System.out.println(STR."3: \{absolute1.relativize(absolute2)}");
        System.out.println(STR."4: \{relative1.relativize(relative2)}");
        System.out.println(STR."5: \{absolute1.relativize(relative1)}");
